...
export function ImageGallery({ images, altTextPrefix }: ImageGalleryProps) {
  ...
  return (
    <>
      ...
      {/* Lightbox Modal with Double Layer for Complete Coverage */}
      {selectedImage !== null && (
        <>
          {/* Extra backdrop layer to ensure complete coverage */}
          <div 
          ...
          >
            ...
            <div
              className="flex items-center justify-center w-full max-w-7xl bg-white rounded-lg p-8"

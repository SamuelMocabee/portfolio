...
export function ImageGallery({ images, altTextPrefix }: ImageGalleryProps) {
  ...
  return (
    <>
      ...
      {selectedImage !== null && (
        <div
          className="fixed inset-0 z-50 bg-black/95 flex flex-col items-center justify-center gap-6 p-6"
          onClick={closeImage}
          role="dialog"
          aria-modal="true"
        ...
        >
          {/* Main Image */}
          <div
            className="flex items-center justify-center w-full max-w-7xl"
